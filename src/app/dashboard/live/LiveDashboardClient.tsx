        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Loading live market data...</p>
                </div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="glass-dark rounded-2xl p-8 text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Unable to Load Live Data</h2>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {bullishSectors.map(sector => (
                            <SectorCard key={sector.id} sector={sector} basePath="/dashboard/live" />
                        ))}
                    </div>
                </section>
            )}
